...
a. Merge with the above data set.
b. Look at the dates of events. What does it mean if an event date is recorded before
start of study or after end of study? Should these observations be discarded or not?
Make the appropriate changes to the table.
c. Make sure to remove repeated events(more than 1 event for the same individual).

#### Analyis {-#anal}

$$\text{Incidence Rates overall} = \frac{ {\textit{total number of events}} }{ \textit{total person-years} }
$$

$$\text{Incidence rates by year} = \frac{ {\textit{total number of events for each year}} }{ \textit{person-years for each year} }
$$


\[
  text{Incidence rates by year by age bands} = \frac{Total \ number \ of \ events for \ each \ year \  per \  age \ band}{person-years \ for \ each \ year \  per \ age \ band}
\]
...
datatable(codes, 
          caption='Diagnostic codes retrieved from the .. Codesheet ',
...
ggplot(df_total, aes(x = IR_1000_PY, y = y_order)) +
  geom_point() +
  geom_errorbarh(aes(xmin = IR_1000_PY_95L, xmax = IR_1000PY_95H)) +
...
# plot the forest plot
ggplot(df_2017_P, aes(x = IR_1000_PY, y = y_order)) +
  geom_point() +
  geom_errorbarh(aes(xmin = IR_1000_PY_95L, xmax = IR_1000PY_95H)) +
  facet_grid(Diagnosis ~ ., scales = "free_y", space = "free_y") +
  theme_bw() +
...
# plot the forest plot
ggplot(df_2018_P, aes(x = IR_1000_PY, y = y_order)) +
  geom_point() +
  geom_errorbarh(aes(xmin = IR_1000_PY_95L, xmax = IR_1000PY_95H)) +
  facet_grid(Diagnosis ~ ., scales = "free_y", space = "free_y") +
  theme_bw() +
...
# plot the forest plot
ggplot(df_2019_P, aes(x = IR_1000_PY, y = y_order)) +
  geom_point() +
  geom_errorbarh(aes(xmin = IR_1000_PY_95L, xmax = IR_1000PY_95H)) +
  facet_grid(Diagnosis ~ ., scales = "free_y", space = "free_y") +
  theme_bw() +
...
# plot the forest plot
ggplot(df_2020_P, aes(x = IR_1000_PY, y = y_order)) +
  geom_point() +
  geom_errorbarh(aes(xmin = IR_1000_PY_95L, xmax = IR_1000PY_95H)) +
  facet_grid(Diagnosis ~ ., scales = "free_y", space = "free_y") +
  theme_bw() +
