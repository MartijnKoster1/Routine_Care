...
df_2017_P$y_order <- factor(paste(df_2017_P$Diagnosis, df_2017_P$Age_Bands, sep = " - "), levels = unique(paste(df_2017_P$Diagnosis, df_2017_P$Age_Bands, sep = " - ")), ordered = TRUE)
# plot the forest plot
...
df_2018_P$y_order <- factor(paste(df_2018_P$Diagnosis, df_2018_P$Age_Bands, sep = " - "), levels = unique(paste(df_2018_P$Diagnosis, df_2018_P$Age_Bands, sep = " - ")), ordered = TRUE)
# plot the forest plot
...
df_2019_P$y_order <- factor(paste(df_2019_P$Diagnosis, df_2019_P$Age_Bands, sep = " - "), levels = unique(paste(df_2019_P$Diagnosis, df_2019_P$Age_Bands, sep = " - ")), ordered = TRUE)
# plot the forest plot
...
df_2020_P$y_order <- factor(paste(df_2020_P$Diagnosis, df_2020_P$Age_Bands, sep = " - "), levels = unique(paste(df_2020_P$Diagnosis, df_2020_P$Age_Bands, sep = " - ")), ordered = TRUE)
# plot the forest plot
