...
```{r}
dftotal$end_incidence <- dftotal$end_date_record
dftotal$end_incidence[is.na(dftotal$end_incidence)] <- 20210101 # even over nadenken, hoe reken je iemand die eind november neervalt?
