...
We have learned to take data from various tables, and structure it to a dataset which can be analysed. In addition, we have learned that a lot of data is needed to make inference about incidence rates. That is, when data needs to be stratified, the confidence will get lower when there are not enough person years. Hence, Common Data Models are used, to improve the data quality. 
