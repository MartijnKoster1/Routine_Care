...
### DAG
| Domain knowledge was used to create a DAG that explains the causal structure present in the data. The variable 'contact with chiropractor' was given as a proxy for the unobserved variable healthy lifestyle. 
