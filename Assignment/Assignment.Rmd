...
| The first adjusted model is to use the PS as a covariate. In theory the treated and untreated group should have equal distributions given   This method can also provide more statistical power and precision than matching, particularly when the sample size is large \citep{austin}. 
