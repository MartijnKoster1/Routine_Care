...
| The first adjusted model is to use the PS as a covariate. In theory   This method can also provide more statistical power and precision than matching, particularly when the sample size is large (Austin, 2011). 
...
Nederlands Huisartsen Genootschap, *Risico hart- en vaatziekten verlagen*, <https://www.thuisarts.nl/risico-hart-en-vaatziekten-verlagen>, accesed: 23-2-2023
