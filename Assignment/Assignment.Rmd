...
```{r dag, fig.cap = 'DAG model with Vaccine as exposure and hospitalization as outcome', fig.height='50%'}
dag1 <- dagify(
...
_Belangrijk_ Wat moet hier nog bij? 
...
Maybe write something about matching here? 
