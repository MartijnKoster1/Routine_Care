...
### DAG
| Domain knowledge was used to create a DAG that explains the causal structure present in the data. The variable 'contact with chiropractor' was given as a proxy for the unobserved variable healthy lifestyle. A flu vaccination is season, hence does the time from last contact with the chiropractor form a causal path to vaccination status. 
