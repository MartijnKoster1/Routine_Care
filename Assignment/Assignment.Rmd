...
|     The last model in Table \@ref(tab:res) is an IPW model with stabilised weights. This model also presents a negative association between vaccination and hospitalisation (Adjusted OR: `r res_ipw[1]`, 95% CI `r res_ipw[2]` to `r res_ipw[3]`; p `r print_p_value(res_ipw_p)`). The C-statistic is presenting moderate discriminatory power (C = `r res_ipw_c`). 
...
Nederlands Huisartsen Genootschap, _Risico hart- en vaatziekten verlagen_, https://www.thuisarts.nl/risico-hart-en-vaatziekten-verlagen, accessed: 23-2-2023
